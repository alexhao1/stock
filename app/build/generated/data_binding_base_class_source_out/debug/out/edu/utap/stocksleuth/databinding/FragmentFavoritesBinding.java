...
public final class FragmentFavoritesBinding implements ViewBinding {
  ...
  private FragmentFavoritesBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView favoriteRV, @NonNull EditText searchFavorite) {
    this.rootView = rootView;
    this.favoriteRV = favoriteRV;
    this.searchFavorite = searchFavorite;
  }
  ...
  public static FragmentFavoritesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.search_favorite;
      EditText searchFavorite = ViewBindings.findChildViewById(rootView, id);
      if (searchFavorite == null) {
        break missingId;
      }

      return new FragmentFavoritesBinding((ConstraintLayout) rootView, favoriteRV, searchFavorite);
    }
